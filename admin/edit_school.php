				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							?>
							<form role="form" action="db_edit_school.php" method="post" onsubmit="return confirm('คุณต้องการแก้ไขข้อมูลโรงเรียนนี้ ใช่หรือไม่?');">
								<div class="row">
									<input type="hidden" name="school_code" class="form-control" value="<?php echo $_GET['code'] ?>">
									<input type="hidden" name="act" class="form-control" value="update_profile">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" action="db_edit_school.php" method="post" onsubmit="return confirm('คุณต้องการแก้ไขข้อมูลโรงเรียนนี้ ใช่หรือไม่?');">
								<div class="row">
									<input type="hidden" name="school_code" class="form-control" value="<?php echo $_GET['code'] ?>">
									<input type="hidden" name="act" class="form-control" value="update_password">
									<div class="col-md-6 col-lg-3">
										รหัสผ่าน <input type="password" name="school_pass" class="form-control" value=""><br>
									</div>
									<div class="col-md-6 col-lg-3">
										ยืนยันรหัสผ่าน <input type="password" name="school_pass_confirm" class="form-control" value=""><br>
									</div>
								</div>
								<div class="form-group">
									<input type="submit" class="btn btn-lg btn-success btn-block" value="แก้ไข">
