<?php
  ...
  $sql = "SELECT register.school_id, register.id, register.score, school.display, register.subject_id, register.name FROM register INNER JOIN school ON register.school_id=school.code WHERE register.subject_id='".$subject_id."'";
