                                  ...
                                  <?php
                                        ...
                                        if (mysql_num_rows($result) > 0) {
                                            while($row = mysql_fetch_array($result)) {
                                                ...
                                                echo "    <a href=\"school_pdf_export.php?s=".$row['code']."\" class=\"btn btn-primary\">export pdf</a> <a href=\"reportsubject_edit.php?s=".$row['code']."\" class=\"btn btn-warning\">Gen Certification</a></td>";
