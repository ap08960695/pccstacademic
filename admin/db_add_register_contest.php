...
if ($_GET['type'] == "student") {
	...
	$sql = "INSERT INTO register_teacher (school_id,subject_id,name,status,running_year) VALUES ('" . $_POST['register_school'] . "','" . $_POST['register_contest'] . "','" . $_POST['register_name'] . "',1,'$running_year')";
	$result = mysqli_query_log($conn, $sql);
}
if (!$result) {
	mysqli_close($conn);
