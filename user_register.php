					...
					<div class="panel panel-default">
						<form role="form" action="savedata.php" method="post">
							...
							<div class="panel-body">
										...
										if (mysqli_num_rows($result) > 0) {
											while ($row = mysqli_fetch_array($result)) {
												...
												if ($row_role['value'] == "all" && $row_running['value'] == $running_year) {
													...
													echo "    </td>";
													echo "</tr>";
												} else if (mysqli_num_rows($result_register) > 0) {
													echo "<tr class=\"odd gradeX\">";
													echo "    <td>" . $row['code'] . "</td>";
													echo "    <td>" . $row['contest_name'] . " (" . $row['person'] . " คน)" . "</td>";
													echo "    <td>" . $row['type'] . "</td>";
													echo "    <td>" . $row['education'] . "</td>";
													echo "    <td class=\"center\">";
													if ($row_running['value'] != $running_year || $row_role['value'] == "edit" || $row_role['value'] == "view") {
														for ($i = 0; $i < $row['person']; $i++) {
															if ($row_register = mysqli_fetch_array($result_register)) {
																echo "        <input type=\"text\" name=\"student['" . $row['code'] . "'][]\" class=\"form-control\" onkeyup=\"checkFilled(this)\" value=\"" . $row_register['name'] . "\" ";
															} else {
															...
															if ($row_running['value'] != $running_year) {
																echo "disabled>";
															} else if ($row_role['value'] == "edit") {
																echo ">";
								...
								<center>
									<?php
									if ($row_running['value'] == $running_year && ($row_role['value'] == "all" || $row_role['value'] == "edit"))
